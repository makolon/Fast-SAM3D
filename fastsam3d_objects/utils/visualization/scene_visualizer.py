...
from fastsam3d_objects.data.dataset.tdfy.transforms_3d import compose_transform
from fastsam3d_objects.utils.visualization.plotly.plot_scene import plot_tdfy_scene
from fastsam3d_objects.utils.visualization.image_mesh import (
    mesh_from_pointmap,
    create_textured_mesh,
)

from fastsam3d_objects.utils.visualization.plotly.plot_scene import NO_BACKGROUND, default_axisargs
from fastsam3d_objects.utils.visualization.plotly.save_scene import make_video as make_scene_video
