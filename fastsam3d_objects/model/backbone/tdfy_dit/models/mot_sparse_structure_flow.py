...
from fastsam3d_objects.data.utils import (
    tree_reduce_unique,
)
...
class SparseStructureFlowTdfyWrapper(SparseStructureFlowModel):
    ...
    def forward(
        ...
        **condition_kwargs,
        ...
        latent_dict = self.project_input(latents_dict,fast_update_indices)
    ...
    def project_input(
        ...
        for latent_name in self.input_latent_mappings:
            ...
            if fast_update_indices is not None and latent_name == 'shape':
                x = x[:, fast_update_indices, :]
